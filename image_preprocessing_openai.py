"""
Image Preprocessing Agent using OpenAI API
Handles image resizing, preprocessing, and bounding box annotation
Uses OpenAI Agent SDK (Swarm) with OpenAI API key
"""
...
def create_preprocessing_agent():
    """Create and configure the image preprocessing agent for OpenAI API"""
    
    agent = Agent(
        name="Image Preprocessing Agent - OpenAI",
        model="gpt-4o",  # Set OpenAI model as default
...
# Main execution
def main():
    """Main function to run the agent with OpenAI API"""
    ...
    if not openai_api_key or openai_api_key.startswith('sk-'):
        if not openai_api_key:
            ...
            print("2. Edit .env file and set: OPENAI_API_KEY=sk-...your-key")
            return
    ...
    print("=" * 70)
    print("Image Preprocessing Agent - OpenAI API Edition")
    print("=" * 70)
    print("\nAgent initialized and ready to process images!")
    print("Using OpenAI API for intelligent processing")
